<template>
  <v-navigation-drawer id="app-drawer" v-model="inputValue" app dark floating persistent mobile-break-point="991" width="260">
    <v-img :src="logo" :gradient="sidebarOverlayGradiant"  height="100%">
      <v-layout class="fill-height" tag="v-list" column>
        ...
        <v-list-tile v-if="responsive">
          <v-text-field class="purple-input search-input" label="Buscar..." color="purple"/>
        </v-list-tile>
...
export default {
  data: () => ({
    logo: './img/cmc-header-logo-desktop.png',
    links: [
      {
        to: '/dashboard',
        icon: 'mdi-view-dashboard',
        text: 'Reporte Cedulas Amparo'
      },
      {
        to: '/user-profile',
        icon: 'mdi-account',
